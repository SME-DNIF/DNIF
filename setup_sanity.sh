if [[ $EUID -ne 0 ]]; then
	...
	tar fcz System_Report_$dateis.tar.gz --absolute-names Setup_Report_$dateis.log OS_logs_$dateis.tar.gz history_$dateis.log top_$dateis.log ps_pcpu_$dateis.log ps_rss_$dateis.log service_logs_$dateis.tar.gz
